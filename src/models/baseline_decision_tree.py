...
"""
DecisionTreeModel implementation for personality prediction project.
...
class DecisionTreeModel(BaseModel):
    """
    Decision Tree classifier model with optional hyperparameter tuning.
    ...
    def build_model(self):
        """
        Build the Decision Tree model. If param_grid is provided, use RandomizedSearchCV for hyperparameter tuning.
        """
