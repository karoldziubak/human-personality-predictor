...
"""
XGBoostModel implementation for personality prediction project.
...
class XGBoostModel(BaseModel):
    """
    XGBoost classifier model with optional hyperparameter tuning.
    ...
    def build_model(self):
        """
        Build the XGBoost model. If param_grid is provided, use RandomizedSearchCV for hyperparameter tuning.
        """
